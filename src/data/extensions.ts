...
export const EXTENSIONS: Extension[] = [
  ...
  { id: "hardhat", name: "Hardhat Node", description: "Local Ethereum development network. Runs natively in WebContainer — starts a local chain at localhost:8545 with 20 pre-funded accounts for testing.", price: "0.002", category: "web3", icon: "⛏️", color: "#FFF100", tags: ["solidity", "ethereum", "hardhat"], runtimeType: "webcontainer", webcontainerCommand: "echo \"module.exports={solidity:'0.8.19',networks:{hardhat:{chainId:1337}}};\" > hardhat.config.cjs && pnpm add -D hardhat@^2.22.0 --prefer-offline 2>/dev/null | tail -1 && npx hardhat node --config hardhat.config.cjs" },
