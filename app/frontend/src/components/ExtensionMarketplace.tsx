...
export default function ExtensionMarketplace({
  ...
  const getPort = (id: string) => {
    const ports: Record<string, string> = {
      portainer: "9000", nginx: "8080",
      postgres: "5050", redis: "8083",
      ...
      {selectedExt ? (
        <div className="flex-1 flex flex-col overflow-hidden">
          ...
          <div className="flex-1 overflow-y-auto p-6 space-y-6">
            ...
            {/* Compose snippet — docker type only */}
            {selectedExt.composeSnippet && (!selectedExt.runtimeType || selectedExt.runtimeType === "docker") && (
              <div>
